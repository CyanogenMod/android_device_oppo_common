...
public class TouchscreenGestures {
    ...
    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "Circle (o)"),
        new TouchscreenGesture(1, "Two-finger down (||)"),
        new TouchscreenGesture(2, "Left arrow (<)"),
        new TouchscreenGesture(3, "Right arrow (>)"),
        new TouchscreenGesture(4, "Down arrow (V)"),
    };
