...
public class TouchscreenGestures {
    ...
    private static final String[] GESTURE_PATHS = {
        "/proc/touchpanel/circle_gesture_enable",
        "/proc/touchpanel/down_swipe_gesture_enable",
        "/proc/touchpanel/down_arrow_gesture_enable",
        "/proc/touchpanel/left_arrow_gesture_enable",
        "/proc/touchpanel/right_arrow_gesture_enable",
    };

    // Id, name, keycode
    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "Circle", 250),
        new TouchscreenGesture(1, "Two-finger downwards", 251),
        new TouchscreenGesture(4, "Downwards arrow", 252),
        new TouchscreenGesture(2, "Leftwards arrow", 253),
        new TouchscreenGesture(3, "Rightwards arrow", 254),
    };
